...
namespace Aimeos\Client\Html\ProdAccount\History;
    ...
    implements \Aimeos\Client\Html\Iface
{
    ...
    /** client/html/prodaccount/history/standard/subparts
     ...
     * @category Developer
     */
    private $subPartPath = 'client/html/prodaccount/history/standard/subparts';

    /** client/html/prodaccount/history/service/name
    ...
    public function getBody($uid = '')
    {
         ...
         */
        $confkey = 'client/html/prodaccount/history';

        if (($html = $this->getCached('body', $uid, $prefixes, $confkey)) === null) {
            $view = $this->getView();

            /** client/html/prodaccount/history/standard/template-body
             ...
             *
             */
            $tplconf = 'client/html/prodaccount/history/standard/template-body';
            $default = 'prodaccount/history/body-standard.php';
            ...
            try {
                ...
                $view->catlistErrorList = $view->get('historyErrorList', []) + $error;
            } catch (\Aimeos\Controller\Frontend\Exception $e) {
                $error = array($context->getI18n()->dt('controller/frontend', $e->getMessage()));
                $view->cztlistErrorList = $view->get('historyErrorList', []) + $error;
            } catch (\Aimeos\MShop\Exception $e) {
                $error = array($context->getI18n()->dt('mshop', $e->getMessage()));
                $view->catlistErrorList = $view->get('historyErrorList', []) + $error;
            } catch (\Exception $e) {
                $error = array($context->getI18n()->dt('client', 'A non-recoverable error occured'));
                $view->detailErrorList = $view->get('historyErrorList', []) + $error;
                $this->logException($e);
            }
    ...
    public function getHeader($uid = '')
    {
        ...
        if (($html = $this->getCached('header', $uid, $prefixes, $confkey)) === null) {
             ...
             */
            $tplconf = 'client/html/prodaccount/history/standard/template-header';
            $default = 'prodaccount/history/header-standard.php';
    ...
    public function getSubClient($type, $name = null)
    {
        ...
        return $this->createSubClient('prodaccount/history/' . $type, $name);
    }
    ...
    public function modifyBody($content, $uid)
    {
        ...
        return $this->replaceSection($content, $this->getView()->csrf()->formfield(), 'prodaccount.history.csrf');
    }
